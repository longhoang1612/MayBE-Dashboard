...
public class DetailCategoryAdapter extends RecyclerView.Adapter<DetailCategoryAdapter.ItemPhoneViewHolder> {

    private List<ItemPhoneProduct> mPhoneProducts;
    private LayoutInflater mLayoutInflater;
    private OnClickProductListener mOnClickProductListener;

    public DetailCategoryAdapter(List<ItemPhoneProduct> phoneProducts, OnClickProductListener onClickProductListener) {
    ...
    public ItemPhoneViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(PhoneFragment.mIsViewWithCatalog ? R.layout.item_product_list : R.layout.item_product, viewGroup, false);
